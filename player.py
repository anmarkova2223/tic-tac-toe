...
class Player:
    def __init__(self, letter):
        # letters are x and o for player
        self.letter = letter

    # we want all player to get a next move given a game
...
class GeniusComputer(Player):
    ...
    def get_move(self, game):
        if len(game.available_moves()) == 9:
            ...
            # get square based off of minimax algorithm
    ...
    def minimax(self, state, player):
        ...
        for possible_move in state.available_moves():
            ...
            # step 3: undo that move to try others
